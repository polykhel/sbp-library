...
@SpringBootTest(
    ...
    properties = {
        ...
        "core.api-docs.default-include-pattern=/scanned/.*",
        "core.api-docs.host=test.core.com",
        "core.api-docs.protocols=http,https",
        "core.api-docs.title=test title",
        "core.api-docs.description=test description",
        "core.api-docs.version=test version",
        "core.api-docs.terms-of-service-url=test tos url",
        "core.api-docs.contact-name=test contact name",
        "core.api-docs.contact-email=test contact email",
        "core.api-docs.contact-url=test contact url",
        "core.api-docs.license=test license name",
        "core.api-docs.license-url=test license url",
...
public class SpringfoxAutoconfigurationTest {
    ...
    void generatesSwaggerV2() throws Exception {
        mockMvc.perform(get("/v2/api-docs"))
            ...
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.paths./scanned/test").exists())
            .andExpect(jsonPath("$.host").value("test.core.com"))
    ...
    @SpringBootApplication(
        scanBasePackages = "com.polykhel.sbp.config.apidoc",
        exclude = {
    ...
    @ConfigurationPropertiesScan("com.polykhel.sbp.config")
    @Controller
